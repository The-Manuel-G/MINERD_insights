          ...
          children: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                foregroundColor: const Color.fromARGB(255, 0, 112, 216),
                backgroundColor: const Color.fromARGB(255, 255, 255, 255),
                padding:
                    const EdgeInsets.symmetric(horizontal: 100, vertical: 20),
                side: const BorderSide(
                    color: Color.fromARGB(255, 201, 11, 11), width: 2),
            ...
            OutlinedButton(
              ...
              style: OutlinedButton.styleFrom(
                foregroundColor: const Color.fromARGB(255, 201, 11, 11),
                padding:
                    const EdgeInsets.symmetric(horizontal: 90, vertical: 20),
                side: const BorderSide(
                    color: Color.fromARGB(255, 0, 112, 216), width: 2),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(30),
                ),
              ),
